...
; 0000 0050 // Mode: CTC top=OCR0A
; 0000 0051 // OC0A output: Toggle on compare match
; 0000 0052 // OC0B output: Toggle on compare match
; 0000 0053 TCCR0A=0x52;
	LDI  R30,LOW(82)
	OUT  0x24,R30
; 0000 0054 TCCR0B=0x01;
	LDI  R30,LOW(1)
	OUT  0x25,R30
; 0000 0055 TCNT0=0x00;
	LDI  R30,LOW(0)
	OUT  0x26,R30
; 0000 0056 OCR0A=0xFF;
	LDI  R30,LOW(255)
	OUT  0x27,R30
...
; 0000 0072 // Clock value: Timer 2 Stopped
...
; 0000 008F // ADC Clock frequency: 625,000 kHz
; 0000 0090 // ADC Voltage Reference: AVCC pin
; 0000 0091 // ADC Auto Trigger Source: None
; 0000 0092 // Only the 8 most significant bits of
; 0000 0093 // the AD conversion result are used
; 0000 0094 // Digital input buffers on ADC0: On, ADC1: Off, ADC2: Off, ADC3: Off
; 0000 0095 // ADC4: Off, ADC5: Off
; 0000 0096 DIDR0=0x3E;
	LDI  R30,LOW(62)
	STS  126,R30
; 0000 0097 ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(96)
	STS  124,R30
; 0000 0098 ADCSRA=0x85;
	LDI  R30,LOW(133)
	STS  122,R30
; 0000 0099 
