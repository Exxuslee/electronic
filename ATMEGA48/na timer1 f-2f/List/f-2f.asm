...
; 0000 0035 CLKPR=0x80;
	LDI  R30,LOW(128)
	STS  97,R30
; 0000 0036 CLKPR=0x00;
	LDI  R30,LOW(0)
	STS  97,R30
...
; 0000 003D // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=Out Func1=Out Func0=In
; 0000 003E // State7=T State6=T State5=T State4=T State3=T State2=0 State1=0 State0=T
...
; 0000 0043 // Func6=In Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0044 // State6=T State5=T State4=T State3=T State2=T State1=T State0=T
...
; 0000 0054 TCCR0A=0x00;
	LDI  R30,LOW(0)
	OUT  0x24,R30
; 0000 0055 TCCR0B=0x00;
	OUT  0x25,R30
...
; 0000 005C // Clock value: 20000,000 kHz
; 0000 005D // Mode: Fast PWM top=ICR1
; 0000 005E // OC1A output: Non-Inv.
; 0000 005F // OC1B output: Non-Inv.
; 0000 0060 // Noise Canceler: Off
; 0000 0061 // Input Capture on Falling Edge
; 0000 0062 // Timer 1 Overflow Interrupt: Off
; 0000 0063 // Input Capture Interrupt: Off
; 0000 0064 // Compare A Match Interrupt: Off
; 0000 0065 // Compare B Match Interrupt: Off
; 0000 0066 TCCR1A=0xA2;
	LDI  R30,LOW(162)
	STS  128,R30
; 0000 0067 TCCR1B=0x19;
	LDI  R30,LOW(25)
	STS  129,R30
; 0000 0068 TCNT1H=0x00;
	RCALL SUBOPT_0x1
; 0000 0069 TCNT1L=0x00;
; 0000 006A ICR1H=0x03;
	LDI  R30,LOW(3)
	STS  135,R30
; 0000 006B ICR1L=0x00;
	LDI  R30,LOW(0)
	STS  134,R30
; 0000 006C OCR1AH=0x01;
	LDI  R30,LOW(1)
	STS  137,R30
; 0000 006D OCR1AL=0x00;
	LDI  R30,LOW(0)
	STS  136,R30
; 0000 006E OCR1BH=0x02;
	LDI  R30,LOW(2)
	STS  139,R30
...
; 0000 0077 ASSR=0x00;
	STS  182,R30
; 0000 0078 TCCR2A=0x00;
	STS  176,R30
; 0000 0079 TCCR2B=0x00;
	STS  177,R30
...
; 0000 0083 // Interrupt on any change on pins PCINT16-23: Off
; 0000 0084 EICRA=0x00;
	STS  105,R30
; 0000 0085 EIMSK=0x00;
	OUT  0x1D,R30
; 0000 0086 PCICR=0x00;
	STS  104,R30
; 0000 0087 
; 0000 0088 // Timer/Counter 0 Interrupt(s) initialization
; 0000 0089 TIMSK0=0x00;
	STS  110,R30
; 0000 008A // Timer/Counter 1 Interrupt(s) initialization
; 0000 008B TIMSK1=0x00;
	STS  111,R30
; 0000 008C // Timer/Counter 2 Interrupt(s) initialization
; 0000 008D TIMSK2=0x00;
	STS  112,R30
; 0000 008E 
...
; 0000 0092 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 0093 ADCSRB=0x00;
	LDI  R30,LOW(0)
	STS  123,R30
; 0000 0094 
; 0000 0095 // ADC initialization
; 0000 0096 // ADC Clock frequency: 625,000 kHz
; 0000 0097 // ADC Voltage Reference: Int., cap. on AREF
; 0000 0098 // ADC Auto Trigger Source: Free Running
...
; 0000 009C // ADC4: On, ADC5: On
; 0000 009D DIDR0=0x00;
	STS  126,R30
; 0000 009E ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(255)
	STS  124,R30
; 0000 009F ADCSRA=0xA5;
	LDI  R30,LOW(165)
	STS  122,R30
; 0000 00A0 ADCSRB&=0xF8;
	LDI  R26,LOW(123)
	LDI  R27,HIGH(123)
	LD   R30,X
	RCALL SUBOPT_0x0
...
; 0000 00AA       ICR1H = temp;
	STS  135,R4
; 0000 00AB       OCR1AH= temp / 10;
	RCALL SUBOPT_0x2
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL __DIVW21
	STS  137,R30
; 0000 00AC       OCR1BH= temp / 5;
	RCALL SUBOPT_0x2
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	RCALL __DIVW21
