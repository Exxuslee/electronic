...
; 0000 0034 // Func7=In Func6=In Func5=Out Func4=Out Func3=In Func2=In Func1=In Func0=In
; 0000 0035 // State7=T State6=T State5=0 State4=0 State3=T State2=T State1=T State0=T
...
; 0000 0044 // Clock value: 16384,000 kHz
; 0000 0045 // Mode: Fast PWM top=OCR1A
; 0000 0046 // OC1A output: Toggle
; 0000 0047 // OC1B output: Toggle
...
; 0000 004E TCCR1A=0x53;
	LDI  R30,LOW(83)
	OUT  0x2F,R30
; 0000 004F TCCR1B=0x19;
	LDI  R30,LOW(25)
	OUT  0x2E,R30
...
; 0000 0053 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0054 OCR1AH=0x03;
	LDI  R30,LOW(3)
	OUT  0x2B,R30
; 0000 0055 OCR1AL=0xC0;
	LDI  R30,LOW(192)
	OUT  0x2A,R30
; 0000 0056 OCR1BH=0x01;
	LDI  R30,LOW(1)
	OUT  0x29,R30
; 0000 0057 OCR1BL=0xF0;
	LDI  R30,LOW(240)
	OUT  0x28,R30
; 0000 0058 
