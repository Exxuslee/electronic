...
; 0000 004A // Mode: Fast PWM top=03FFh
; 0000 004B // OC1A output: Non-Inv.
...
; 0000 0053 TCCR1A=0x83;
	LDI  R30,LOW(131)
	OUT  0x2F,R30
; 0000 0054 TCCR1B=0x0D;
	LDI  R30,LOW(13)
	OUT  0x2E,R30
...
; 0000 0076       if (OCR1A > 0)      if (PIND.4 == 0) OCR1A--;
	RCALL SUBOPT_0x0
	MOVW R26,R30
	RCALL __CPW02
	BRSH _0x6
	...
	OUT  0x2A+1,R31
	OUT  0x2A,R30
; 0000 0077       if (OCR1A < 0x03FF) if (PIND.5 == 0) OCR1A++;
_0x7:
_0x6:
	RCALL SUBOPT_0x0
	CPI  R30,LOW(0x3FF)
