...
_0x0:
	.DB  0x45,0x78,0x78,0x75,0x73,0x20,0x20,0x0
	.DB  0x25,0x78,0x20,0x20,0x25,0x64,0x20,0x20
...
_0x6:
	...
	BRLT _0x7
	LDI  R30,LOW(0)
	STS  _start_S0000001000,R30
; 0000 0044 if (start < 8)
_0x7:
	LDS  R26,_start_S0000001000
	CPI  R26,LOW(0x8)
	BRSH _0x8
; 0000 0045     {
...
; 0000 0051 return bufer;
	LDS  R30,_bufer_S0000001000
	LDS  R31,_bufer_S0000001000+1
	RJMP _0x2080002
; 0000 0052 }
;
...
SUBOPT_0x2:
	STS  _bufer_S0000001000,R30
	STS  _bufer_S0000001000+1,R31
	RET
