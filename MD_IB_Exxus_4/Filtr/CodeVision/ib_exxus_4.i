...
unsigned int array1 [0x80];      
unsigned int array_t [0x80];     
...
signed int TEMPfaza, W;

unsigned int Nmax = 0x80; 

for (a=0; a<=255; a++)   array1[TCNT1 / 2] = read_adc();

for (a=0; a<=128; a++)   array_t[a] = sin(2 * 3.1415926535897 * a / 127 /10 ) * 50 + 50;   
...
TEMPfaza = TEMPfaza * 3.1415926535897 / 180;
...
for (a=0; a<=0x80; a++)
{
array3[a].re = array3[a].re / 0x80;
array3[a].im = array3[a].im / 0x80;
array3[a].amp = array3[a].amp / 0x80;
