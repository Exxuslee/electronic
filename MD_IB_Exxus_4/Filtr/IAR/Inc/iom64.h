...
/* Extended I/O space */
SFR_B(DDRF,   0x61) /* Port F Data Direction Register */
SFR_B(PORTF,  0x62) /* Port F Data Register */
SFR_B(PING,   0x63) /* Port G Input Pins Address */
SFR_B(DDRG,   0x64) /* Port G Data Direction Register */
SFR_B(PORTG,  0x65) /* Port G Data Register */
SFR_B(SPMCR,  0x68) /* Store Program Memory Control Register */
...
SFR_W(OCR1C,  0x78) /* Timer/Counter1 Output Compare Register C */
SFR_B(TCCR1C, 0x7A) /* Timer/Counter1 Control Register C */
...
SFR_W(ICR3,   0x80) /* Timer/Counter3 Input Capture Register */
SFR_W(OCR3C,  0x82) /* Timer/Counter3 Output Compare Register C */
SFR_W(OCR3B,  0x84) /* Timer/Counter3 Output Compare Register B */
SFR_W(OCR3A,  0x86) /* Timer/Counter3 Output Compare Register A */
SFR_W(TCNT3,  0x88) /* Timer/Counter3 */
SFR_B(TCCR3B, 0x8A) /* Timer/Counter3 Control Register B */
SFR_B(TCCR3A, 0x8B) /* Timer/Counter3 Control Register A */
SFR_B(TCCR3C, 0x8C) /* Timer/Counter3 Control Register C */
SFR_B(ADCSRB, 0x8E) /* ADC Control and Status Register B */
