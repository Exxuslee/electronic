...
; 0000 0026 // Func5=In Func4=In Func3=In Func2=In Func1=In Func0=Out
; 0000 0027 // State5=T State4=T State3=T State2=T State1=T State0=0
...
; 0000 002F // OC0A output: Non-Inverted PWM
; 0000 0030 // OC0B output: Disconnected
; 0000 0031 TCCR0A=0x81;
	LDI  R30,LOW(129)
	OUT  0x2F,R30
; 0000 0032 TCCR0B=0x01;
	LDI  R30,LOW(1)
	OUT  0x33,R30
; 0000 0033 TCNT0=0x00;
	LDI  R30,LOW(0)
	OUT  0x32,R30
; 0000 0034 OCR0A=0x00;
	OUT  0x36,R30
; 0000 0035 OCR0B=0x00;
	OUT  0x29,R30
; 0000 0036 
; 0000 0037 // External Interrupt(s) initialization
; 0000 0038 // INT0: Off
; 0000 0039 // Interrupt on any change on pins PCINT0-5: Off
; 0000 003A GIMSK=0x00;
	OUT  0x3B,R30
; 0000 003B MCUCR=0x00;
	OUT  0x35,R30
; 0000 003C 
; 0000 003D // Timer/Counter 0 Interrupt(s) initialization
; 0000 003E TIMSK0=0x00;
	OUT  0x39,R30
; 0000 003F 
; 0000 0040 // Analog Comparator initialization
; 0000 0041 // Analog Comparator: Off
; 0000 0042 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 0043 ADCSRB=0x00;
	LDI  R30,LOW(0)
	OUT  0x3,R30
; 0000 0044 DIDR0=0x00;
	OUT  0x14,R30
; 0000 0045 
; 0000 0046 // ADC initialization
; 0000 0047 // ADC Clock frequency: 1000,000 kHz
; 0000 0048 // ADC Bandgap Voltage Reference: Off
; 0000 0049 // ADC Auto Trigger Source: ADC Stopped
; 0000 004A // Only the 8 most significant bits of
; 0000 004B // the AD conversion result are used
; 0000 004C // Digital input buffers on ADC0: On, ADC1: On, ADC2: On, ADC3: On
; 0000 004D DIDR0&=0x03;
	IN   R30,0x14
	ANDI R30,LOW(0x3)
	OUT  0x14,R30
; 0000 004E DIDR0|=0x00;
	IN   R30,0x14
	OUT  0x14,R30
; 0000 004F ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 0050 ADCSRA=0x83;
	LDI  R30,LOW(131)
	OUT  0x6,R30
; 0000 0051 
; 0000 0052 while (1)
