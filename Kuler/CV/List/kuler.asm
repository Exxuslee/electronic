...
; 0000 0029 // Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 002A // State5=T State4=T State3=T State2=T State1=T State0=T
...
; 0000 0038 OCR0B=0x00;
	OUT  0x29,R30
; 0000 0039 
; 0000 003A // External Interrupt(s) initialization
; 0000 003B // INT0: Off
; 0000 003C // Interrupt on any change on pins PCINT0-5: Off
; 0000 003D GIMSK=0x00;
	OUT  0x3B,R30
; 0000 003E MCUCR=0x00;
	OUT  0x35,R30
; 0000 003F 
; 0000 0040 // Timer/Counter 0 Interrupt(s) initialization
; 0000 0041 TIMSK0=0x00;
	OUT  0x39,R30
; 0000 0042 
; 0000 0043 // Analog Comparator initialization
; 0000 0044 // Analog Comparator: On
; 0000 0045 // Digital input buffers on AIN0: Off, AIN1: Off
; 0000 0046 DIDR0=0x03;
	LDI  R30,LOW(3)
	OUT  0x14,R30
; 0000 0047 ACSR=0x00;
	LDI  R30,LOW(0)
	OUT  0x8,R30
; 0000 0048 ADCSRB=0x00;
	OUT  0x3,R30
; 0000 0049 
; 0000 004A while (1)
_0x3:
...
; 0000 004D       //PORTB.4=ACO;
; 0000 004E       if (ACSR==0x10) PORTB.2=1, PORTB.3=0, PORTB.4=1;
	IN   R30,0x8
	CPI  R30,LOW(0x10)
	BRNE _0x6
	SBI  0x18,2
	CBI  0x18,3
	SBI  0x18,4
; 0000 004F       if (ACSR==0x30) PORTB.2=0, PORTB.3=1, PORTB.4=0;
_0x6:
	IN   R30,0x8
	CPI  R30,LOW(0x30)
	BRNE _0xD
