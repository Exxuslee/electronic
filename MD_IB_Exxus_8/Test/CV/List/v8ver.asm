...
; 0000 0035 #asm
; 0000 0036     in   r30,mcucr
; 0000 0037     cbr  r30,__sm_mask
; 0000 0038     sbr  r30,__se_bit | __sm_adc_noise_red
; 0000 0039     out  mcucr,r30
; 0000 003A     sleep
; 0000 003B     cbr  r30,__se_bit
; 0000 003C     out  mcucr,r30
; 0000 003D #endasm
; 0000 003E return adc_data;
; 0000 003F }
;
...
; 0000 006C // Mode: Ph. correct PWM top=OCR1A
...
; 0000 0082 // Clock value: Timer 2 Stopped
; 0000 0083 // Mode: Normal top=FFh
...
; 0000 0095 // Analog Comparator: On
; 0000 0096 // The Analog Comparator's positive input is
; 0000 0097 // connected to the Bandgap Voltage Reference
; 0000 0098 // Analog Comparator Input Capture by Timer/Counter 1: On
; 0000 0099 ACSR=0x44;
	LDI  R30,LOW(68)
	OUT  0x8,R30
