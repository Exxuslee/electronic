...
; 0000 0049 // Func7=In Func6=Out Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 004A // State7=T State6=0 State5=T State4=T State3=T State2=T State1=T State0=T
...
; 0000 0050 // Clock value: 8000,000 kHz
...
; 0000 0089 TIMSK0=0x00;
	STS  110,R30
; 0000 008A 
; 0000 008B // Timer/Counter 1 Interrupt(s) initialization
; 0000 008C TIMSK1=0x00;
	STS  111,R30
; 0000 008D 
; 0000 008E // Timer/Counter 2 Interrupt(s) initialization
; 0000 008F TIMSK2=0x00;
	STS  112,R30
; 0000 0090 
; 0000 0091 // USART initialization
; 0000 0092 // USART disabled
; 0000 0093 UCSR0B=0x00;
	STS  193,R30
; 0000 0094 
...
; 0000 0098 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 0099 ADCSRB=0x00;
	LDI  R30,LOW(0)
	STS  123,R30
; 0000 009A DIDR1=0x00;
	STS  127,R30
; 0000 009B 
; 0000 009C // ADC initialization
; 0000 009D // ADC Clock frequency: 1000,000 kHz
; 0000 009E // ADC Voltage Reference: AVCC pin
; 0000 009F // ADC Auto Trigger Source: Free Running
; 0000 00A0 // Digital input buffers on ADC0: On, ADC1: On, ADC2: On, ADC3: On
; 0000 00A1 // ADC4: On, ADC5: On
; 0000 00A2 DIDR0=0x00;
	STS  126,R30
; 0000 00A3 ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(96)
	STS  124,R30
; 0000 00A4 ADCSRA=0xA3;
	LDI  R30,LOW(163)
	STS  122,R30
; 0000 00A5 ADCSRB&=0xF8;
	LDS  R30,123
	ANDI R30,LOW(0xF8)
	STS  123,R30
; 0000 00A6 
