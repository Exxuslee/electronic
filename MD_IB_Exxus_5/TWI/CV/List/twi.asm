...
; 0000 00AA // Clock value: Timer 1 Stopped
...
; 0000 00B0 // Timer 1 Overflow Interrupt: Off
...
; 0000 00D7 SFIOR=0x00;
	...
	OUT  0x30,R30
; 0000 00D8 
; 0000 00D9 // 2 Wire Bus initialization
; 0000 00DA // Generate Acknowledge Pulse: On
; 0000 00DB // 2 Wire Bus Slave Address: 44h
; 0000 00DC // General Call Recognition: Off
; 0000 00DD // Bit Rate: 390,095 kHz
; 0000 00DE TWSR=0x00;
	OUT  0x1,R30
; 0000 00DF TWBR=0x0D;
	LDI  R30,LOW(13)
