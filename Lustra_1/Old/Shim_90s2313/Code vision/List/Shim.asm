...
; 0000 00A4 // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=Out Func1=In Func0=In
; 0000 00A5 // State7=T State6=T State5=T State4=T State3=0 State2=0 State1=T State0=T
...
; 0000 00AB // State6=T State5=P State4=P State3=P State2=P State1=T State0=T
; 0000 00AC PORTD=0x3C;
	LDI  R30,LOW(60)
	OUT  0x12,R30
; 0000 00AD DDRD=0x00;
	LDI  R30,LOW(0)
...
; 0000 00B1 // Clock value: 1000,000 kHz
; 0000 00B2 TCCR0=0x00;
	OUT  0x33,R30
; 0000 00B3 TCNT0=0xA0;
	LDI  R30,LOW(160)
	OUT  0x32,R30
; 0000 00B4 
...
; 0000 00C2 TCNT1L=0x00;
	OUT  0x2C,R30
; 0000 00C3 OCR1H=0x60;
	LDI  R30,LOW(96)
	OUT  0x2B,R30
; 0000 00C4 OCR1L=0x00;
	LDI  R30,LOW(0)
	OUT  0x2A,R30
; 0000 00C5 
...
; 0000 00DA       if (PIND.2 == 0)
	SBIC 0x10,2
	RJMP _0x14
; 0000 00DB         {
; 0000 00DC         OCR1=OCR1+0x40;
	IN   R30,0x2A
	IN   R31,0x2A+1
	SUBI R30,LOW(-64)
	SBCI R31,HIGH(-64)
...
; 0000 00E0         };
_0x14:
; 0000 00E1       if (PIND.3 == 0)
	SBIC 0x10,3
	RJMP _0x18
; 0000 00E2         {
; 0000 00E3         OCR1=OCR1-0x40;
	IN   R30,0x2A
	IN   R31,0x2A+1
	SUBI R30,LOW(64)
	SBCI R31,HIGH(64)
...
; 0000 00E7         };
_0x18:
; 0000 00E8       if (PIND.4 == 0)
	SBIC 0x10,4
	RJMP _0x1C
; 0000 00E9         {
; 0000 00EA         skvazh++;
	INC  R4
; 0000 00EB         while (PIND.4 ==0)
_0x1D:
	SBIS 0x10,4
; 0000 00EC             {
; 0000 00ED             };
...
; 0000 00EE         };
_0x1C:
; 0000 00EF       if (PIND.5 == 0)
	SBIC 0x10,5
	RJMP _0x20
; 0000 00F0         {
; 0000 00F1         skvazh--;
	DEC  R4
; 0000 00F2         while (PIND.5 ==0)
_0x21:
	SBIS 0x10,5
; 0000 00F3             {
; 0000 00F4             };
