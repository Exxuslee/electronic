...
; 0000 0009 {
	...
	.CSEG
; 0000 000A ADMUX=(adc_input & 0x3f) | ADC_VREF_TYPE;
;	adc_input -> Y+0
...
; 0000 001C 
; 0000 001D // Crystal Oscillator division factor: 1
; 0000 001E #pragma optsize-
; 0000 001F CLKPR=0x80;
	LDI  R30,LOW(128)
	OUT  0x26,R30
; 0000 0020 CLKPR=0x00;
	LDI  R30,LOW(0)
	OUT  0x26,R30
; 0000 0021 #ifdef _OPTIMIZE_SIZE_
; 0000 0022 #pragma optsize+
; 0000 0023 #endif
; 0000 0024 
; 0000 0025 // Input/Output Ports initialization
; 0000 0026 // Port A initialization
; 0000 0027 // Func7=In Func6=Out Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0028 // State7=T State6=0 State5=T State4=T State3=T State2=T State1=T State0=T
...
; 0000 002D // Func3=In Func2=In Func1=In Func0=In
; 0000 002E // State3=T State2=T State1=T State0=T
...
; 0000 0036 // OC0A output: Disconnected
; 0000 0037 // OC0B output: Disconnected
...
; 0000 003A TCNT0=0x00;
	OUT  0x32,R30
; 0000 003B OCR0A=0x00;
	OUT  0x36,R30
; 0000 003C OCR0B=0x00;
	OUT  0x3C,R30
; 0000 003D 
...
; 0000 0056 // INT0: Off
; 0000 0057 // Interrupt on any change on pins PCINT0-7: Off
; 0000 0058 // Interrupt on any change on pins PCINT8-11: Off
; 0000 0059 MCUCR=0x00;
	OUT  0x35,R30
; 0000 005A GIMSK=0x00;
	OUT  0x3B,R30
; 0000 005B 
...
; 0000 0060 TIMSK1=0x00;
	OUT  0xC,R30
; 0000 0061 
; 0000 0062 // Universal Serial Interface initialization
; 0000 0063 // Mode: Disabled
; 0000 0064 // Clock source: Register & Counter=no clk.
; 0000 0065 // USI Counter Overflow Interrupt: Off
; 0000 0066 USICR=0x00;
	OUT  0xD,R30
; 0000 0067 
...
; 0000 0070 // ADC Clock frequency: 1000,000 kHz
; 0000 0071 // ADC Bipolar Input Mode: Off
; 0000 0072 // ADC Auto Trigger Source: Free Running
; 0000 0073 // Digital input buffers on ADC0: On, ADC1: On, ADC2: Off, ADC3: Off
; 0000 0074 // ADC4: Off, ADC5: Off, ADC6: Off, ADC7: Off
; 0000 0075 DIDR0=0xFC;
	LDI  R30,LOW(252)
	OUT  0x1,R30
; 0000 0076 ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 0077 ADCSRA=0xA3;
	LDI  R30,LOW(163)
	OUT  0x6,R30
; 0000 0078 ADCSRB&=0x68;
	IN   R30,0x3
	ANDI R30,LOW(0x68)
	OUT  0x3,R30
; 0000 0079 
...
; 0000 007D       timer =TCNT1;
	__INWR 2,3,44
; 0000 007E       if (timer > 0x1fff) PORTA.6=1;
	LDI  R30,LOW(8191)
	LDI  R31,HIGH(8191)
	CP   R30,R2
	CPC  R31,R3
