...
; 0000 007A SFIOR=0x00;
	...
	OUT  0x30,R30
; 0000 007B 
; 0000 007C // 2 Wire Bus initialization
; 0000 007D // Generate Acknowledge Pulse: Off
; 0000 007E // 2 Wire Bus Slave Address: 11h
; 0000 007F // General Call Recognition: On
; 0000 0080 // Bit Rate: 390,095 kHz
; 0000 0081 TWAR=0x00;
	OUT  0x2,R30
; 0000 0082 TWSR=0x00;
	OUT  0x1,R30
