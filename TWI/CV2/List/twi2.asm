...
; 0000 0083       unsigned char data = 0xdd;
; 0000 0084       unsigned char adres = 0x00;
; 0000 0085       unsigned char temp;
; 0000 0086 
; 0000 0087       #asm ("wdr")
	SBIW R28,3
	LDI  R30,LOW(0)
...
; 0000 0088       i2c_start();
	CALL _i2c_start
; 0000 0089       i2c_write(adres);
	LDD  R30,Y+1
	ST   -Y,R30
	CALL _i2c_write
; 0000 008A       i2c_write(data);
	LDD  R30,Y+2
	ST   -Y,R30
	CALL _i2c_write
; 0000 008B       i2c_stop();
	CALL _i2c_stop
; 0000 008C       if (temp == 0xFd) PORTA.0 = 1;
	LD   R26,Y
	CPI  R26,LOW(0xFD)
	BRNE _0x6
	SBI  0x1B,0
