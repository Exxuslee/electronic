...
; 0000 0021 CLKPR=0x80;
	LDI  R30,LOW(128)
	OUT  0x26,R30
; 0000 0022 CLKPR=0x00;
	LDI  R30,LOW(0)
	OUT  0x26,R30
...
; 0000 0029 // Func2=In Func1=In Func0=In
; 0000 002A // State2=T State1=T State0=T
...
; 0000 002F // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0030 // State7=T State6=T State5=T State4=T State3=0 State2=0 State1=0 State0=0
...
; 0000 0035 // Func6=In Func5=Out Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0036 // State6=T State5=0 State4=T State3=P State2=P State1=P State0=P
; 0000 0037 PORTD=0x0F;
	OUT  0x12,R30
; 0000 0038 DDRD=0x20;
	LDI  R30,LOW(32)
	OUT  0x11,R30
...
; 0000 003D // Mode: Fast PWM top=OCR0A
; 0000 003E // OC0A output: Disconnected
; 0000 003F // OC0B output: Non-Inverted PWM
; 0000 0040 TCCR0A=0x23;
	LDI  R30,LOW(35)
	OUT  0x30,R30
; 0000 0041 TCCR0B=0x09;
	LDI  R30,LOW(9)
	OUT  0x33,R30
; 0000 0042 TCNT0=0x00;
	LDI  R30,LOW(0)
	OUT  0x32,R30
; 0000 0043 OCR0A=0x01;
	RCALL SUBOPT_0x0
...
; 0000 0048 // Clock value: Timer 1 Stopped
; 0000 0049 // Mode: Normal top=FFFFh
...
; 0000 004E // Timer 1 Overflow Interrupt: Off
...
; 0000 005E // INT0: Off
; 0000 005F // INT1: Off
; 0000 0060 // Interrupt on any change on pins PCINT0-7: Off
...
; 0000 0077         OCR0A++;
	...
	SUBI R30,-LOW(1)
	OUT  0x36,R30
; 0000 0078         while (PIND.0 ==0)
_0x7:
	SBIC 0x10,0
	RJMP _0x9
; 0000 0079             {
; 0000 007A             if (OCR0A == 0 )      OCR0A=1;
	RCALL SUBOPT_0x2
	BRNE _0xA
	RCALL SUBOPT_0x0
; 0000 007B             if (OCR0A <= OCR0B)   OCR0B=0;
_0xA:
	RCALL SUBOPT_0x3
	BRLO _0xB
	RCALL SUBOPT_0x1
...
; 0000 0080         OCR0A--;
	...
	SUBI R30,LOW(1)
	OUT  0x36,R30
; 0000 0081         while (PIND.1 ==0)
_0xD:
	SBIC 0x10,1
	RJMP _0xF
; 0000 0082             {
; 0000 0083             if (OCR0A == 0 )      OCR0A=1;
	RCALL SUBOPT_0x2
	BRNE _0x10
	RCALL SUBOPT_0x0
; 0000 0084             if (OCR0A <= OCR0B)   OCR0B=0;
_0x10:
	RCALL SUBOPT_0x3
	BRLO _0x11
	RCALL SUBOPT_0x1
...
; 0000 0089         OCR0B++;
	...
	SUBI R30,-LOW(1)
	OUT  0x3C,R30
; 0000 008A         while (PIND.2 ==0)
_0x13:
	SBIC 0x10,2
	RJMP _0x15
; 0000 008B             {
; 0000 008C             if (OCR0A == 0 )      OCR0A=1;
	RCALL SUBOPT_0x2
	BRNE _0x16
	RCALL SUBOPT_0x0
; 0000 008D             if (OCR0A <= OCR0B)   OCR0B=0;
_0x16:
	RCALL SUBOPT_0x3
	BRLO _0x17
	RCALL SUBOPT_0x1
...
; 0000 0092         OCR0B--;
	...
	SUBI R30,LOW(1)
	OUT  0x3C,R30
; 0000 0093         while (PIND.3 ==0)
_0x19:
	SBIC 0x10,3
	RJMP _0x1B
; 0000 0094             {
; 0000 0095             if (OCR0A == 0 )      OCR0A=1;
	RCALL SUBOPT_0x2
	BRNE _0x1C
	RCALL SUBOPT_0x0
; 0000 0096             if (OCR0A <= OCR0B)   OCR0B=0;
_0x1C:
	RCALL SUBOPT_0x3
	BRLO _0x1D
	RCALL SUBOPT_0x1
